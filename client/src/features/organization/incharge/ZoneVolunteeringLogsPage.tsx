...
export const ZoneVolunteeringLogsPage = () => {
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div>
          <div className="flex items-center gap-2">
            ...
            <span className="inline-flex items-center gap-1 px-2.5 py-0.5 rounded-full text-[10px] font-black uppercase tracking-wider bg-indigo-50 text-indigo-700 border border-indigo-200">
              <ShieldCheck className="w-3 h-3" /> Zone Scoped
            </span>
          </div>
                  ...
                  <div className="bg-[#F9FAFB] p-4 rounded-xl border border-[#E5E7EB] space-y-2">
                    ...
                    {selectedSubmission.reviewedAt ? (
                      ...
                      <div className="flex items-center gap-2 text-xs text-amber-700 bg-amber-50 p-2.5 rounded-lg border border-amber-200">
                        ...
                        <span>This submission is pending review by you.</span>
                      </div>
                    )}
                  </div>
                </CardContent>
...
export default ZoneVolunteeringLogsPage
